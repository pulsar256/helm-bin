...
org.label-schema.docker.cmd="docker run -e HELM_VERSION=v2.14.1 -eKUBECTL_VERSION=v1.14.3 -e KUBE_MASTER=$KUBE_MASTER -e KUBE_TOKEN=$KUBE_TOKEN -e KUBE_CA=$KUBE_CA pulsar256/helm-bin ls"
